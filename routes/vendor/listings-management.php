...
Route::post('/portal/vendor/properties/create', function (Request $request) {
    ...
    $validated = $request->validate([
        ...
        'excursion_difficulty' => ['nullable', Rule::in(['easy', 'moderate', 'hard', 'extreme', 'executive', 'interactive', 'immersive', 'hybrid'])],
        ...
        'allow_specific_date_booking' => ['nullable', Rule::in(['0', '1'])],
        'package_included_pax' => ['nullable', 'integer', 'min:1', 'max:1000'],
        'extra_person_price' => ['nullable', 'numeric', 'min:0'],
        'extra_person_policy' => ['nullable', 'string', 'max:1000'],
        'included_services' => ['nullable', 'array'],
        'included_services.*' => ['required', 'string', 'max:80'],
        'program_customization_mode' => ['nullable', 'string', 'max:120'],
