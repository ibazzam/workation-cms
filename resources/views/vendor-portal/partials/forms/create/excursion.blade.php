...
<form class="ops-form" method="POST" action="/portal/vendor/properties/create">
    ...
    <div class="ops-form-grid">
        ...
        <div class="ops-field">
            ...
            <input id="property_adult_price_local" name="adult_price_local" class="ops-input" type="number" min="0" step="0.01" value="{{ old('adult_price_local') }}" placeholder="e.g. 450.00">
            <p class="map-help">Price for Maldivian nationals.</p>
        </div>
        <div class="ops-field">
            <label for="property_adult_price_foreign">Adult Price — Foreign (MVR)</label>
            <input id="property_adult_price_foreign" name="adult_price_foreign" class="ops-input" type="number" min="0" step="0.01" value="{{ old('adult_price_foreign') }}" placeholder="e.g. 850.00">
            <p class="map-help">Price for international guests.</p>
        </div>
        <div class="ops-field">
            <label for="property_child_price_local">Child Price — Local (MVR)</label>
            <input id="property_child_price_local" name="child_price_local" class="ops-input" type="number" min="0" step="0.01" value="{{ old('child_price_local') }}" placeholder="e.g. 225.00">
        </div>
        <div class="ops-field">
            <label for="property_child_price_foreign">Child Price — Foreign (MVR)</label>
            <input id="property_child_price_foreign" name="child_price_foreign" class="ops-input" type="number" min="0" step="0.01" value="{{ old('child_price_foreign') }}" placeholder="e.g. 425.00">
        </div>
