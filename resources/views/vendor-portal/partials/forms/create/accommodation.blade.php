            ...
            <div class="ops-form-grid">
                ...
                @if ($accommodationListingCategory === 'liveaboard')
                    <div class="ops-field ops-field-wide">
                        ...
                        <p class="map-help" style="margin-bottom:8px;">Use one map pin for the main vessel/embark base, then define embark point, stopovers, and end point below. This helps vendors keep route planning and location context together.</p>
                    </div>
                    <div class="ops-field">
                        <label for="liveaboard_start_point">Embark Point</label>
                        <input id="liveaboard_start_point" name="start_point" class="ops-input" type="text" maxlength="120" value="{{ old('start_point') }}" placeholder="e.g. Male Jetty">
                    </div>
                    <div class="ops-field">
                        <label for="liveaboard_end_point">End Point / Disembark</label>
                        <input id="liveaboard_end_point" name="end_point" class="ops-input" type="text" maxlength="120" value="{{ old('end_point') }}" placeholder="e.g. Gan Harbor">
                    </div>
                    <div class="ops-field">
