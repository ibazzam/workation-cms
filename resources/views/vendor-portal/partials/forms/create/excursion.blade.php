{{-- Standalone create form: Excursion (same fields as water_sports) --}}
<form class="ops-form" method="POST" action="/portal/vendor/properties/create">
    ...
    <div class="ops-form-grid">
        ...
        <div class="ops-field">
            <label for="property_max_guests">Max Guests (overall capacity)</label>
        ...
        <div class="ops-field ops-field-wide">
            ...
            <input id="property_meeting_point" name="meeting_point" class="ops-input" type="text" maxlength="200" value="{{ old('meeting_point') }}">
        </div>
        <div class="ops-field ops-field-wide">
        ...
        <div class="ops-field ops-field-wide">
            ...
            <textarea id="property_exclusions" name="exclusions" class="ops-textarea" rows="3" maxlength="2000">{{ old('exclusions') }}</textarea>
        </div>
        <div class="ops-field">
        ...
        <div class="ops-field ops-field-wide">
            ...
            <textarea id="property_weather_cancellation_policy" name="weather_cancellation_policy" class="ops-textarea" rows="2" maxlength="1000">{{ old('weather_cancellation_policy') }}</textarea>
        </div>
        ...
        <div class="ops-field ops-field-wide">
            <div class="map-picker"><div id="propertyMap" aria-label="Pin excursion location"></div></div>
            <p class="map-help">Click to pin the meeting / departure point.</p>
        </div>
