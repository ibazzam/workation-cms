<form class="inline-table-form update-row-form" method="POST" action="/portal/vendor/properties/{{ $propertyId }}/update" data-property-edit-form="{{ $propertyId }}" data-property-edit-category="{{ vendorPortalCanonicalCategory((string) $editCategory) ?? $editCategory }}" hidden>
                                                                @csrf
                                                                <input class="ops-input" name="name" type="text" maxlength="160" value="{{ $property->name }}" placeholder="Listing name" required>
                                                                ...
                                                                <input class="ops-input" name="address_line" type="text" maxlength="255" value="{{ (string) ($propertyDetails['address_line'] ?? '') }}" placeholder="Address line / landmark" data-property-edit-scope="geo">
                                                                ...
                                                                <input class="ops-input" name="property_contact_number" type="text" maxlength="60" value="{{ (string) ($propertyDetails['property_contact_number'] ?? '') }}" placeholder="Phone / WhatsApp" data-property-edit-scope="geo">
                                                                <input class="ops-input" name="property_contact_email" type="email" maxlength="190" value="{{ (string) ($propertyDetails['property_contact_email'] ?? '') }}" placeholder="Contact email" data-property-edit-scope="geo">
                                                                ...
                                                                <input class="ops-input" name="contact_number" type="text" maxlength="60" value="{{ (string) ($propertyDetails['contact_number'] ?? '') }}" placeholder="Phone / WhatsApp" data-property-edit-scope="transport">
                                                                ...
                                                                <input class="ops-input" name="transport_departure_state" type="text" maxlength="120" value="{{ (string) ($propertyDetails['transport_departure_state'] ?? '') }}" placeholder="Departure atoll/state" data-property-edit-scope="transport">
                                                                <input class="ops-input" name="transport_departure_city" type="text" maxlength="120" value="{{ (string) ($propertyDetails['transport_departure_city'] ?? '') }}" placeholder="Departure island/city" data-property-edit-scope="transport">
                                                                <input class="ops-input" name="transport_arrival_state" type="text" maxlength="120" value="{{ (string) ($propertyDetails['transport_arrival_state'] ?? '') }}" placeholder="Arrival atoll/state" data-property-edit-scope="transport">
                                                                <input class="ops-input" name="transport_arrival_city" type="text" maxlength="120" value="{{ (string) ($propertyDetails['transport_arrival_city'] ?? '') }}" placeholder="Arrival island/city" data-property-edit-scope="transport">
