    ...
    public static function defaultPolicy(): array
    {
        return [
            ...
            'tax_components' => [
                ...
                [
                    'code' => 'green_tax_local',
                    'label' => 'Green Tax (Local)',
                ...
                [
                    'code' => 'green_tax_foreign_under_50',
                    'label' => 'Green Tax (Foreign Under 50 Rooms)',
                    'calculation_mode' => 'per_guest_per_night',
                    'default_rate' => 6.0,
                ...
                [
                    'code' => 'green_tax_foreign_50_plus',
                    'label' => 'Green Tax (Foreign 50+ Rooms)',
                    'calculation_mode' => 'per_guest_per_night',
                    'default_rate' => 12.0,
                    'applies_to' => 'foreign_national',
                    'applies_to_categories' => ['accommodation'],
